...
<div class="container">
    <form class="wp-login-form" method="post" action="#" id="login-form">

        <h2 class="form-title">Войдите в свою учетную запись</h2>
        ...
        <a href="<?php echo esc_url( home_url( '/восстановление-пароля/' ) ); ?>">
            Забыли пароль?
        </a>

        <div class="btn-registers">
            <button type="submit" class="btn-register login">войти</button>

            <p class="has-account">
                У вас еще нет аккаунта?
                <a href="<?php echo esc_url( home_url( '/регистрация/' ) ); ?>">Регистрация</a>
            </p>
        </div>
